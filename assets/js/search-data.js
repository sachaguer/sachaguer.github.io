...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "Repositories",
          description: "Check out those repositories if you want to know more on my work.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-unions-3500-cosmological-results-have-been-submitted-on-the-arxiv-check-it-out",
          title: '📝 UNIONS-3500 cosmological results have been submitted on the ArXiv, check it out!...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/sachaguer", "_blank");
        },
      },{
        id: 'social-inspire',
        title: 'Inspire HEP',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=Xf7E5lEAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
